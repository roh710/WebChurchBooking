...
SELECT users.user_firstname, users.user_lastname, users.user_email, users.user_kor_name, users.user_title, users.user_name, users.user_pwd, cdnj_group.user_perm_level, cdnj_group.grId, cdnj_group.grName FROM users
JOIN cdnj_group
