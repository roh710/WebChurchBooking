	  ...
	  <!-- loop through rm_reserved VIEW to populate Reservation table -->
	    <?php foreach ($reservations as $row) : ?>
	        <tr>
	            ...
	            <td><?php echo escape($row["reservPurpose"]); ?></td>
	            <td><?php echo escape($row["grName"]); ?></td>
	            <td><?php echo escape($row["status"]); ?></td>
	            <td><a id="ed_btn" href="reserv_pass.php?ed=<?php echo escape($row["reservID"]); ?>">Edit</a></td>
	            ...
	            <td><a id="dp_btn" href="reservation.php?dapr=<?php echo escape($row["reservID"]); ?>">D-apr</a></td>
	        </tr>
	    <?php endforeach; ?>
	    </tbody>
	</table>
