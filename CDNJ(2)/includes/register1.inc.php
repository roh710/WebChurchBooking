...
// Enter the new user in the database
	...
	$sql = "INSERT INTO users (user_firstname, user_lastname,	user_email,	user_group_fk, user_kor_name, user_name, user_pwd)
	VALUES
	(:user_firstname, :user_lastname, :user_email, :user_group_fk, :user_kor_name, :user_name, :user_pwd)";
